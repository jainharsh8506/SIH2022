...
urlpatterns = [
    ...
    path("all_college_institution.html", views.all_college_institution, name="all_college_institution"),
    ...
    path("all_standalone_institution.html", views.all_standalone_institution, name="all_standalone_institution"),
    ...
    path("all_university.html", views.all_university, name="all_university"),
